...
<h2 class="mantine-Text-root mantine-Title-root mantine-19w8sr"><a class="mantine-mcyp1w" href="#api">API</a></h2>
...
# My MDX File with JSX Example

Here's an example of using JSX in an MDX file:
